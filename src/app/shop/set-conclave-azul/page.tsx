...
export default function ProductoAzul() {
  ...
  useEffect(() => {
    fetch('/api/inventory?slug=set-conclave-azul')
      .then(r => r.json())
      .then(setInventory);
  }, []);
  ...
  function agregarCarrito() {
    ...
    addToCart({ id: 'set-conclave-azul', slug: 'set-conclave-azul', nombre: 'Set Conclave Azul', talla: tallaSeleccionada, precio: 599, imagen: '/IMG_9368.jpg' });
    setAgregado(true);
      ...
      <main className="pt-16 min-h-screen">
        <div className="max-w-screen-xl mx-auto px-6 py-8">
          <p className="text-[11px] text-stone-400 mb-8">
            <Link href="/" className="hover:text-stone-700">Inicio</Link> / Set Conclave Azul
          </p>
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="flex items-baseline gap-3 mb-2">
                <p className="font-display text-xl text-stone-400 line-through">$899 <span className="text-sm font-sans">MXN</span></p>
