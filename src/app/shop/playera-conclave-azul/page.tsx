...
export default function PlayeraAzul() {
  ...
  useEffect(() => {
    fetch('/api/inventory?slug=playera-conclave-azul')
      .then(r => r.json())
      .then(setInventory);
  }, []);
  ...
  function agregarCarrito() {
    ...
    addToCart({ id: 'playera-conclave-azul', slug: 'playera-conclave-azul', nombre: 'The Conclave T-Shirt Azul', talla: tallaSeleccionada, precio: 599, imagen: '/IMG_9368.jpg' });
    setAgregado(true);
