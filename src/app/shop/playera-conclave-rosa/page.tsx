...
const FOTOS = ['/IMG_9375.jpg', '/IMG_9371.jpg', '/IMG_9376.jpg', '/PHOTO-2026-04-25-01-02-36.jpg', '/IMG_9378.jpg'];

export default function PlayeraRosa() {
  ...
  function agregarCarrito() {
    ...
    addToCart({ id: 'playera-conclave-rosa', slug: 'playera-conclave-rosa', nombre: 'The Conclave T-Shirt Rosa', talla: tallaSeleccionada, precio: 599, imagen: '/IMG_9375.jpg' });
    setAgregado(true);
      ...
      <main className="pt-16 min-h-screen">
        <div className="max-w-screen-xl mx-auto px-6 py-8">
          <p className="text-[11px] text-stone-400 mb-8">
            <Link href="/" className="hover:text-stone-700">Inicio</Link> / <Link href="/drops" className="hover:text-stone-700">Drops</Link> / The Conclave T-Shirt Rosa
          </p>
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              <div className="aspect-[3/4] overflow-hidden mb-3">
                <img src={FOTOS[fotoActiva]} alt="The Conclave T-Shirt Rosa" className="w-full h-full object-cover transition-all duration-500" />
              </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="font-display text-5xl font-light mb-4">The Conclave T-Shirt Rosa</h1>
