...
const PRODUCTOS = [
  { img: '/PORTADA-OF.jpg', hover: '/IMG_9077.jpg', nombre: 'Set Conclave Rosa', slug: 'set-conclave-rosa', precio: 899, tag: null },
  { img: '/IMG_9367.jpg', hover: '/IMG_9083.jpg', nombre: 'Set Conclave Beige', slug: 'set-conclave-beige', precio: 899, tag: null },
  { img: '/IMG_9377.jpg', hover: '/IMG_9370.jpg', nombre: 'Set Conclave Azul', slug: 'set-conclave-azul', precio: 599, precioOriginal: 899, tag: 'Oferta' },
  { img: '/IMG_9077.jpg', hover: '/IMG_9371.jpg', nombre: 'T-Shirt Conclave Rosa', slug: 'playera-conclave-rosa', precio: 599, tag: null },
  { img: '/IMG_9367.jpg', hover: '/IMG_9083.jpg', nombre: 'T-Shirt Conclave Beige', slug: 'playera-conclave-beige', precio: 599, tag: null },
  { img: '/IMG_9368.jpg', hover: '/IMG_9370.jpg', nombre: 'T-Shirt Conclave Azul', slug: 'playera-conclave-azul', precio: 599, tag: null },
];
        ...
        {getVisible().map((p, i) => (
          <div key={`${p.slug}-${i}`} className="bg-[#F5F2ED]">
            <Link href={`/shop/${p.slug}`} className="group block">
              ...
              >
                {p.tag && (
                  <span className="absolute top-3 left-3 z-10 text-[9px] tracking-[0.15em] uppercase px-2.5 py-1 bg-[#8FA3B1] text-[#1a2530]">{p.tag}</span>
                )}
                <span className="absolute top-3 right-3 z-10 text-[9px] tracking-[0.15em] uppercase px-2.5 py-1 bg-[#B8A87A] text-[#0A0A0A]">Hot Sale</span>
                <img
            ...
            <div className="p-5">
              ...
              <div className="flex items-baseline gap-2 mb-3">
                {'precioOriginal' in p && p.precioOriginal && (
                  <p className="text-sm text-stone-400 line-through">${(p.precioOriginal as number).toLocaleString('es-MX')}</p>
                )}
                <p className="font-display text-lg text-stone-900">${p.precio.toLocaleString('es-MX')} <span className="text-xs text-stone-400">MXN</span></p>
              </div>
      ...
      <main>
        ...
        <section className="relative flex items-center justify-center overflow-hidden" style={{minHeight:"100vh"}}>
          ...
          <div className="relative z-10 text-center px-6">
            {hotSaleActive && (
              <p className="text-[10px] tracking-[0.4em] uppercase text-[#B8A87A] mb-4">✦ Hot Sale — Hasta 33% off</p>
            )}
          ...
          <section className="py-20 bg-[#0A0A0A] text-white overflow-hidden relative">
            ...
            <div className="max-w-screen-xl mx-auto px-6 relative z-10">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
                <div>
                  <p className="text-[10px] tracking-[0.4em] uppercase text-[#B8A87A] mb-4">Oferta limitada</p>
